...
namespace LibraryManagement.Data.Migrations
{
    ...
    [Migration("20240304161944_update-field-publishedbook-table")]
    partial class updatefieldpublishedbooktable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Blog", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(3857));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Book", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 472, DateTimeKind.Local).AddTicks(8375));
                    ...
                    b.Property<DateTime?>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 472, DateTimeKind.Local).AddTicks(8634));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.BookCheckout", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(6062));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(2457));
                    ...
                    b.Property<DateTime?>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(2787));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(4357));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogId = "BF001",
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 3, 4, 23, 19, 44, 477, DateTimeKind.Local).AddTicks(2497),
                            UserAccountId = new Guid("2a738bf3-a14b-488e-b04e-17f918e8d6a4")
                        });
                });
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.FeedBack", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 4, 23, 19, 44, 473, DateTimeKind.Local).AddTicks(5397));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 3, 4, 23, 19, 44, 477, DateTimeKind.Local).AddTicks(2552),
                            PublishedBookId = "7F33BDA5-7C2B-447A-89E3-DC670ACC3646",
                            Rate = 5,
                            UserAccountId = new Guid("2a738bf3-a14b-488e-b04e-17f918e8d6a4")
                        });
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "06399388-c6c5-47fd-a357-9ca44763153b",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "KHA@GMAIL.COM",
                            NormalizedUserName = "KHA@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEADsWmJCrP0sBeyNru/AR/4WWXrrsmOsMDUFQCe+YiVW2ZrQgs5Gt9xngiiNDE8T4w==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "72de4d94-4bc4-41ed-a486-960b9fc389c3",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEGyUiS+YT+UZoUkBTMlOxhvJvMgmBC2cCZmk25/RdnQ9HrUeNcui5CRre0rpkKiiGw==",
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "95d7dc25-a8a8-474f-b527-a38b4be420e8",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2ab7ccde-204e-4acf-ad13-565d5e833791",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
