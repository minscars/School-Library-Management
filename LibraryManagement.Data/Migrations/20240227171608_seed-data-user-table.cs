...
{
    /// <inheritdoc />
    public partial class seeddatausertable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(592)),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(769)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 805, DateTimeKind.Local).AddTicks(7569)),
                    UpdatedTime = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 805, DateTimeKind.Local).AddTicks(7746))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPracticalId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Users_UserPracticalId",
                        column: x => x.UserPracticalId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(1671)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(2753))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(1985)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BookDetailId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2024, 2, 28, 0, 16, 8, 806, DateTimeKind.Local).AddTicks(3229)),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishedBookId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookCheckoutId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookRequests_BookCheckouts_BookCheckoutId",
                        column: x => x.BookCheckoutId,
                        principalTable: "BookCheckouts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookRequests_PublishedBooks_PublishedBookId",
                        column: x => x.PublishedBookId,
                        principalTable: "PublishedBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "Name", "PhoneNumber", "UserCode" },
                values: new object[] { "8a820adb-93d7-4c6f-9404-bdbfc14419f4", null, "Lê Minh Kha", "0398897634", "B2012213" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_UserPracticalId",
                table: "Accounts",
                column: "UserPracticalId",
                unique: true,
                filter: "[UserPracticalId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookRequests_BookCheckoutId",
                table: "BookRequests",
                column: "BookCheckoutId");

            migrationBuilder.CreateIndex(
                name: "IX_BookRequests_PublishedBookId",
                table: "BookRequests",
                column: "PublishedBookId");
