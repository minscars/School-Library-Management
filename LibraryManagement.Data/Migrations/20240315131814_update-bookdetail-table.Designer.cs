...
namespace LibraryManagement.Data.Migrations
{
    ...
    [Migration("20240315131814_update-bookdetail-table")]
    partial class updatebookdetailtable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Blog", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(4037));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Book", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 158, DateTimeKind.Local).AddTicks(8753));
                    ...
                    b.Property<DateTime?>("UpdatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 158, DateTimeKind.Local).AddTicks(9011));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.BookCheckout", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(6229));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(2660));
                    ...
                    b.Property<DateTime?>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(2921));
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(4477));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogId = "BF001",
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 3, 15, 20, 18, 14, 163, DateTimeKind.Local).AddTicks(7295),
                            UserAccountId = new Guid("2a738bf3-a14b-488e-b04e-17f918e8d6a4")
                        });
                });
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.FeedBack", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 15, 20, 18, 14, 159, DateTimeKind.Local).AddTicks(5527));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Content = "Test",
                            CreatedDate = new DateTime(2024, 3, 15, 20, 18, 14, 163, DateTimeKind.Local).AddTicks(7311),
                            PublishedBookId = "7F33BDA5-7C2B-447A-89E3-DC670ACC3646",
                            Rate = 5.0,
                            UserAccountId = new Guid("2a738bf3-a14b-488e-b04e-17f918e8d6a4")
                        });
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "796d9482-248e-46bc-b7c1-f675bc556172",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "KHA@GMAIL.COM",
                            NormalizedUserName = "KHA@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEE6N5Wt7L0qmYpuNZL76k7ikrnH4k0z3lyX2ESEOhVkEiu9FAQ6uopZjL2u+HaReXg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3371e5f9-0c7d-4dc3-8908-3b16e44fc980",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEBU41I9LW0o1UAmQgd2nRKB0OcDqjGumI0M2QaTkdezx4K3ZVBt9ypD63sOd2ogNIg==",
            ...
            modelBuilder.Entity("LibraryManagement.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cbf1a66e-d950-4364-a92e-2651608161ce",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "134028d8-ea23-4bd5-9e0e-cbc48b5a8297",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
