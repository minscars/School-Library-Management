...
namespace LibraryManagement.Application.Services
{
    public class UserAccountService : IUserAccountService
    {
        ...
        public async Task<ApiResult<GetUserAccountResponse>> GetUserAccountByIdAsync(Guid id)
        {
            var data = await _context.UserAccounts
                .Include(u => u.User)
                .Where(u => u.Id == id)
                .Select(u => new GetUserAccountResponse()
                {
                    Id = u.Id.ToString(),
                    Name = u.User.Name,
                    Avatar = u.Avatar,
            ...
            if (data == null)
            {
                return new ApiResult<GetUserAccountResponse>(null)
                {
            ...
            return new ApiResult<GetUserAccountResponse>(data)
            {
                Message = "",
                StatusCode = 200
            };
